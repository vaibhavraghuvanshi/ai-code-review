...
//   isTrial?: boolean;
// }) {
//   const planDurationDays = 30; // example duration
//   const trialDurationDays = 7; // 1 week trial
...
//     ? dayjs(now).add(trialDurationDays, "day").toDate()
//     : null;
...
// // ===============================
// // 2️⃣ Renew subscriptions automatically
// // ===============================
...
//         lt(subscriptions.endDate, dayjs(now).add(1, "day").toDate())
//       )
//     );

//   for (const sub of expiringSoon) {
//     if (!sub.isAutoRenew) {
//       console.log(`⚠️ Skipping renewal for ${sub.userId}, auto-renew off.`);
//       continue;
//     }

//     const newEndDate = dayjs(sub.endDate).add(30, "day").toDate();
...
//   if (expired.length > 0) {
//     console.log(`⚰️ Expired ${expired.length} subscriptions`);
//   } else {
...
//     console.log(`⏱️ ${expiredTrials.length} trials have expired`);
//   }
// }

// // New helper: get subscriptions for a user
...
// // ===============================
// // 6️⃣ Update subscription helpers
// // ===============================
