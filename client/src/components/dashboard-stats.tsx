...
const alerts = [
  {
    ...
    description:
      "The 'calculateMetrics' function exceeds cyclomatic complexity limits. Consider refactoring for maintainability.",
    severity: 'warning',
    action: 'View Details',
  },
  {
    ...
    description:
      "The 'lodash' package is running an older version with known vulnerabilities. Upgrade to the latest stable release.",
    severity: 'error',
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <Button size="sm" variant="outline" data-testid={`button-alert-${alert.id}`}>
                    {alert.action}
                  </Button>
                </div>
              </div>
